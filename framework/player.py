...
class Player(object):
    ...
    def set_playback_stutter_duration_in_milliseconds(self, stutter_duration_in_milliseconds):
        '''
        设置音频stutter_duration_in_milliseconds，测试用
        :return:
        '''
        self._stutter_duration = int(stutter_duration_in_milliseconds)
